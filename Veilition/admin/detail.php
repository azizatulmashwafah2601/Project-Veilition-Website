<h2 style="color: #3F0212; padding-top:10px;"><b>Detail Pembelian</b></h2>
...
<div class="row" style="margin-bottom:10px;">
	...
	<div class="col-md-4">
		...
		Ongkos kirim: Rp. <?= number_format($detail['id_ongkir']); ?>,-<br>
...
<table class="table table-bordered">
	...
	<button name="submit" class="btn btn-danger" style="margin-top: 20px; border-radius:10px">
		<a href="navbar.php?halaman=pembelian" style="color: white; text-decoration: none;">Keluar</a></button>